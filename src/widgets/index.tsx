...
async function onActivate(plugin: ReactRNPlugin) {
  ...
  plugin.track(async (reactivePlugin) => {
    ...
    await reactivePlugin.app.registerCSS(
      "baselight",
      `.light .cloze, .light .non-tested-cloze, .light .cloze .latex-node__tex { border-bottom-color: ${baselight}; }`
    );
  });
  ...
  plugin.track(async (reactivePlugin) => {
    ...
    await reactivePlugin.app.registerCSS(
      "basedark",
      `.dark .cloze, .dark .non-tested-cloze, .dark .cloze .latex-node__tex { border-bottom-color: ${basedark}; }`
    );
  });
  ...
  plugin.track(async (reactivePlugin) => {
    ...
    await reactivePlugin.app.registerCSS(
      "basehover",
      `.cloze:hover, .non-tested-cloze:hover, .cloze .latex-node__tex:hover { border-bottom-color: ${enabledbasehover}; }`
    );
  });
  ...
  plugin.track(async (reactivePlugin) => {
    ...
    await reactivePlugin.app.registerCSS(
      "disabledbasehover",
      `.disabled_cloze:hover, .disabled_cloze .latex-node__tex:hover { border-bottom-color: ${disabledbasehover}; }`
    );
  });
